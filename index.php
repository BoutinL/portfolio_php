  ...
  <br/>
    ...
    <footer class="bg-dark text-white">
      ...
      <p class="text-center m-0">
        <b>Mes réseaux professionnels</b>
      </p>  
      <br/> 
      <div class="btn-group center1" role="group" aria-label="Basic example">
        <button type="button" class="btn btn-secondary" onclick="window.location.href = 'https://www.linkedin.com/in/lo%C3%AFc-boutin-85628b210/';"><b>LinkedIn</b></button> 
        <button type="button" class="btn btn-secondary" onclick="window.location.href = 'https://github.com/NachtV';"><b>GitHub</b></button>
      </div>
      <p class="text-center mt-3">
        <b>Contactez moi:</b><br/>
        boutin.loic@hotmail.com
      </p> 
      
      <div id="scroll-up">
      <a href="#header">
        <img src="https://cdn.shopify.com/s/files/1/0057/4986/6567/files/up.png"/>
      </a>
      </div>
      <br>
    </footer>
